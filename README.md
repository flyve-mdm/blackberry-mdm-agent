...
The MDM Agent takes control of your BlackBerry device and implements the commands given through the UI of the Flyve MDM plugin for GLPI or the Web Dashboard.
...
guidelines for [contributing](./CONTRIBUTING.md) and then check out one of our issues in the [Issues Dashboard](https://github.com/flyve-mdm/blackberry-mdm-agent/issues).
